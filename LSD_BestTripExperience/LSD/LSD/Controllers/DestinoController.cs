...
namespace LSD.Controllers
{
    public class DestinoController : Controller
    {
        ...
        public DestinoController(LSDBD context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Valor")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Valor")] Destino destino)
        {
            if (id != destino.Id)
            {
                return NotFound();
