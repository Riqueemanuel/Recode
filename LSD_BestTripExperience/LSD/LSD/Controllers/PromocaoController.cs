...
namespace LSD.Controllers
{
    ...
    {
        private readonly LSDBD _context;

        public PromocaoController(LSDBD context)
        {
            _context = context;
        }
        ...
        {
            var lSDBD = _context.Promocoes.Include(p => p.Destino);
            return View(await lSDBD.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DotPromo,DestinoId")] Promocao promocao)
        {
            ...
            ViewData["DestinoId"] = new SelectList(_context.Destinos, "Id", "Id", promocao.DestinoId);
            return View(promocao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DotPromo,DestinoId")] Promocao promocao)
        {
            if (id != promocao.Id)
            {
                return NotFound();
